...
import { FIREBASE_AUTH, FIREBASE_DB, FIRESTORE_DB } from '../../auths/FirebaseConfig'; // Import Realtime Database và Firestore
import { ref, set } from 'firebase/database'; // Import hàm để thêm dữ liệu vào Realtime Database
import { doc, setDoc } from 'firebase/firestore'; // Import hàm để thêm dữ liệu vào Firestore
